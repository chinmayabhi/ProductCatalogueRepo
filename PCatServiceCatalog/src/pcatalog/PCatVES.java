...
public class PCatVES {
   ...
   public String getVESDetails(@PathParam("Location")String Location, @PathParam("Package1")String Package1) throws SQLException {
   ...
   @Produces(MediaType.TEXT_PLAIN)
   public String getVESDetails(@PathParam("Location")String Location, @PathParam("Package1")String Package1, @PathParam("Package2")String Package2) throws SQLException {
   ...
   @Produces(MediaType.TEXT_PLAIN)
   public String getVESDetails(@PathParam("Location")String Location, @PathParam("Package1")String Package1, @PathParam("Package2")String Package2, @PathParam("Package1")String Package3) throws SQLException {
